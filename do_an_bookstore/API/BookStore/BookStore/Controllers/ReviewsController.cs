...
namespace BookStore.Controllers
{
    ...
    public class ReviewsController : ControllerBase
    {
        ...
        [HttpGet("getDanhGiaVeSanPhamByAccount/{id}/{userId}")]
        public async Task<IActionResult> GetDanhGiaVeSanPhamByAccount(Guid id, Guid userId)
        {
            var review = await _reviewsService.GetDanhGiaVeSanPhamByAccount(id, userId);
